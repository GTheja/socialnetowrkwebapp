...
function get_posts(){
	...
	while($row_posts = mysqli_fetch_array($run_posts)){
		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6' style = 'border: 1px solid #e6e6e6;'>
					<div class='row'>
						<div class='col-sm-2'>
						<p><img src='users/$user_image' class='img-circle' width='80px' height='80px'></p>
						</div>
						<div class='col-sm-6'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0; display: flex; font-size: 20px; position: relative; left: 15px;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							<h4><small style='color:black; font-size: 10px; position: relative; left: 15px;'>Updated a post on <strong>$post_date</strong></small></h4>
						</div>
						<div class='col-sm-4'>
						</div>
					</div>
	...
	include("pagination.php");
 	...
 	function  single_post(){
		...
		$user_com = $_SESSION['user_email'];		//to get who will comment
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					<div class='row'>
						...
						<div class='col-sm-6'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;  display: flex; position: relative; left: 15px;  font-size: 20px;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							<h4><small style='color:black;  display: flex; position: relative; left: 15px;  font-size: 20px;'>Updated a post on <strong>$post_date</strong></small></h4>
						</div>
						<div class='col-sm-4'>
						</div>
					</div>
 ...
 function user_posts(){
 	...
 	while ($row_posts=mysqli_fetch_array($run_posts)) {
 		...
 		$post_id = $row_posts['post_id'];
 		$user_id = $row_posts['user_id'];
 		$content_id = $row_posts['post_content'];
 		$upload_image = $row_posts['upload_image'];
 		$post_date = $row_posts['post_date'];
...
function search_user(){
	...
	while($row_user = mysqli_fetch_array($run_user)){
		...
		<div class='row'>
		  ...
		  <div class='col-sm-6'>
			 <div class='row' id='find_people' style ='border:1px solid #e6e6e6;'>
			 
				 <div class='col-sm-4'>
				     <a href='user_profile.php?u_id=$user_id' >

				     <img src='users/$user_image' width='100px' height='100px' title='$username' style='float:left; margin:1px;'/>
				     </a>
				 </div><br><br>
				 <div class='col-sm--6'>
					 <a style='text-decoration:none;cursor:pointer;color: #3897f0; display: flex; position: relative; left: 15px;  font-size: 20px;' href='user_profile.php?u_id=$user_id'>
